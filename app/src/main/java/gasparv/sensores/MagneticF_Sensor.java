...
public class MagneticF_Sensor extends Fragment implements SensorEventListener {
    ...
    public static MagneticF_Sensor newInstance(int sectionNumber) {
        MagneticF_Sensor fragment = new MagneticF_Sensor();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_magnetic_f__sensor, container, false);
