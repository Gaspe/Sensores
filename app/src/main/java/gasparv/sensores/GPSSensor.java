...
public class GPSSensor extends Fragment implements LocationListener {
    ...
    public static GPSSensor newInstance(int sectionNumber) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_gpssensor, container, false);
