...
public class AccelerometerSensor extends Fragment implements SensorEventListener {
    ...
    public static AccelerometerSensor newInstance(int sectionNumber) {
        AccelerometerSensor fragment = new AccelerometerSensor();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_accelerometer_sensor, container, false);
