...
public class GravitySensor extends Fragment implements SensorEventListener {
    ...
    public static GravitySensor newInstance(int sectionNumber) {
        GravitySensor fragment = new GravitySensor();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_gravity_sensor, container, false);
