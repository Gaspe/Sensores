...
public class LinearAccSensor extends Fragment implements SensorEventListener {
    ...
    public static LinearAccSensor newInstance(int sectionNumber) {
        LinearAccSensor fragment = new LinearAccSensor();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_linear_acc_sensor, container, false);
