...
public class GyroscopeSensor extends Fragment implements SensorEventListener {
    ...
    public static GyroscopeSensor newInstance(int sectionNumber) {
       GyroscopeSensor fragment = new GyroscopeSensor();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_gyroscope_sensor, container, false);
